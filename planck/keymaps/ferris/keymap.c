...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_ACCESS] = LAYOUT_planck_grid(
    ...
    KC_TRNS, KC_TRNS,       KC_APP,   KC_EXLM, LCTL(KC_DOT), KC_TRNS, KC_TRNS, RGB_HUI, RGB_RMOD, RGB_LTOG,     RGB_MOD, QK_BOOT,
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
  ...
  [7] = {
    ...
    {HSV_OFF},    {HSV_OFF},    {HSV_CYAN},   {HSV_PURPLE}, {HSV_GREEN},  {HSV_OFF}, {HSV_OFF}, {HSV_ORANGE}, {HSV_ORANGE}, {HSV_ORANGE}, {HSV_ORANGE}, {HSV_WHITE},
